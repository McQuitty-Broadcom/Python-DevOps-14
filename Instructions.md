...
- Your login: is _SNCUST014
- The password is _SNCUST014
...
- Your userid is CUST014.
- Your password _MFCUST014.
...
- Run the following commands and ensure we get a 0000 return code:
  - `zowe endevor generate element DOGGOS14 --type COBOL --os --maxrc 0 --sn 1 --cb`
  - `zowe endevor generate element DOGGOS14 --type LNK --os --maxrc 0 --sn 1 --cb`
...
- To execute the application and see the output, we can call `zowe jobs`.
  - `zowe jobs submit dataset _MFCUST014.PUBLIC.JCL(NDRUNDOG) --vasc`
...
`zowe jobs submit data-set "CUST014.PUBLIC.JCL(NDRUNDOG)" --vasc`
...
Username: _JENKINSCUST014
Password: Mfuser14@26
...
The repository URL will be `https://github.com/McQuitty-Broadcom/Python-DevOps-14.git`
