...
- Run the following commands and ensure we get a 0000 return code:
  - `zowe endevor generate DOGGOS14 --type COBOL --os --maxrc 0 --sn 1 --cb`
  - `zowe endevor generate DOGGOS14 --type LNK --os --maxrc 0 --sn 1 --cb`
...
`zowe jobs submit data-set "CUST014.MARBLES.JCL(MARBCOPY)" --vasc`
